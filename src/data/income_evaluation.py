...
class IncomeEvaluationParser(object):
    def __init__(self):

        self.URL = "https://www.kaggle.com/lodetomasi1995/income-classification"
        self.name = "income_evaluation"
        self.file_name = 'income_evaluation.csv'
    ...
    def _parse_file(self,):
        ...
        X = X.loc[:, X.dtypes == np.int64].dropna()
